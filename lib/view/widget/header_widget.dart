...
// ignore_for_file: sort_child_properties_last, unnecessary_new, prefer_const_constructors, prefer_const_literals_to_create_immutables
            ...
            child: Container(
              decoration: new BoxDecoration(
                gradient: new LinearGradient(
                    colors: [
                      // const Color(0xFF20008B).withOpacity(0.5),
                      Color.fromARGB(255, 67, 48, 130).withOpacity(0.5),

                      const Color(0xFF200087).withOpacity(0.5),
